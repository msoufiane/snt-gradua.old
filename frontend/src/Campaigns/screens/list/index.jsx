...
const CampaignsList = function Campaigns() {
  return (
    <ContentWrapper title="Campaigns">
      <Link className="btn btn-default" to="/campaigns/new" style={{ marginTop : '20px', marginBottom : '10px'}}>
